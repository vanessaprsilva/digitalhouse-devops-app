            ...
            stages {
                ...
                stage('Docker push') {
                    steps {
                        ...
                        script {
                            docker.withRegistry('https://258132724776.dkr.ecr.us-east-1.amazonaws.com', 'ecr:us-east-1:aws-user-erc') {
            ...
            steps { 
                script {
                    if(env.GIT_BRANCH=='origin/master'){
                        ...
                        docker.withRegistry('https://258132724776.dkr.ecr.us-east-1.amazonaws.com', 'ecr:us-east-1:aws-user-ecr') {
                            docker.image('projeto-neon').pull()
                        }
